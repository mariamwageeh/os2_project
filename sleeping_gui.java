...
public class sleeping_gui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        client_wating = new javax.swing.JLabel();
        client_later = new javax.swing.JLabel();
        ta_workingT = new javax.swing.JTextField();
        ta_sleepT = new javax.swing.JTextField();
        client_watingT = new javax.swing.JTextField();
        ...
        ta_working.setText("bAs working");

        ta_sleep.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ta_sleep.setForeground(new java.awt.Color(255, 255, 255));
        ta_sleep.setText("bAs sleeping");

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("on chairs");

        client_wating.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        client_wating.setForeground(new java.awt.Color(255, 255, 255));
        client_wating.setText("client waiting");

        client_later.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        client_later.setForeground(new java.awt.Color(255, 255, 255));
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(clientT, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(taT, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(87, 87, 87)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(client_later)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(client_watingT, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(31, 31, 31)
                                .addComponent(client_wating, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(9, 9, 9)
                                .addComponent(jLabel14, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(30, 30, 30)
                                .addComponent(client_later, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGap(44, 44, 44)
                                .addComponent(client_watingT, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    ...
                                    .addComponent(clientT, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void RunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RunActionPerformed
        ...
        numberofbA = Integer.parseInt(taT.getText());
        numberofclient = Integer.parseInt(clientT.getText());
        ...
        Random clientWait = new Random();

        System.out.println(numberofbA - available.availablePermits());

        for (int i = 0; i < numberofclient; i++) {
            Thread client = new Thread(new client(clientWait.nextInt(20), wakeup, chairs, available, i + 1));
            client.start();
        }
...
//        System.out.println(numberofclient - stdtCame);
        System.out.println(getString(numberofbA - available.availablePermits()));
    ...
    private javax.swing.JLabel client_later;
    private javax.swing.JLabel client_wating;
    private javax.swing.JTextField client_watingT;
